(() => {
  var n = {
        ...
        n.exports = function(n) {
          ...
          return e.toString = function() {
            ...
            for (var d = 0; d < n.length; d++) {
              var c = [].concat(n[d]);
              i && a[c[0]] || (void 0 !== r && (void 0 === c[5] || (c[1] = "@layer".concat(c[5].length > 0 ? " ".concat(c[5]) : "", " {").concat(c[1], "}")), c[5] = r), t && (c[2] ? (c[1] = "@media ".concat(c[2], " {").concat(c[1], "}"), c[2] = t) : c[2] = t), o && (c[4] ? (c[1] = "@supports (".concat(c[4], ") {").concat(c[1], "}"), c[4] = o) : c[4] = "".concat(o)), e.push(c))
            }
          }, e
        }
      },
      446: (n, e, t) => {
        ...
        if (i.regeneratorRuntime = void 0, t(989), o) i.regeneratorRuntime = r;
        else try {
      ...
      612: () => {
        ...
        window.initPokiBridge = function(e) {
          n = e, window.unityGame ? window.pokiReady || window.pokiAdBlock ? window.pokiReady ? window.unityGame.SendMessage(e, "ready") : window.pokiAdBlock && window.unityGame.SendMessage(e, "adblock") : window.pokiBridge = e : setTimeout((() => {
      ...
      989: n => {
        ! function(e) {
          ...
          if (d) n.exports = d;
            ...
            S.prototype = v.constructor = k, k.constructor = S, k[l] = S.displayName = "GeneratorFunction", d.isGeneratorFunction = function(n) {
              var e = "function" == typeof n && n.constructor;
              return !!e && (e === S || "GeneratorFunction" === (e.displayName || e.name))
            }, d.mark = function(n) {
              return Object.setPrototypeOf ? Object.setPrototypeOf(n, k) : (n.__proto__ = k, l in n || (n[l] = "GeneratorFunction")), n.prototype = Object.create(v), n
            }, d.awrap = function(n) {
              return {
                __await: n
              }
            }, E(L.prototype), L.prototype[s] = function() {
              return this
            }, d.AsyncIterator = L, d.async = function(n, e, t, i) {
              ...
              dispatchException: function(n) {
                ...
                function i(i, o) {
                  return s.type = "throw", s.arg = n, e.next = i, o && (e.method = "next", e.arg = t), !!o
                }
              ...
              abrupt: function(n, e) {
                ...
                return a.type = n, a.arg = e, r ? (this.method = "next", this.next = r.finallyLoc, f) : this.complete(a)
              },
              complete: function(n, e) {
                if ("throw" === n.type) throw n.arg;
                return "break" === n.type || "continue" === n.type ? this.next = n.arg : "return" === n.type ? (this.rval = this.arg = n.arg, this.method = "return", this.next = "end") : "normal" === n.type && e && (this.next = e), f
              },
              finish: function(n) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                  var t = this.tryEntries[e];
                  if (t.finallyLoc === n) return this.complete(t.completion, t.afterLoc), T(t), f
                }
              },
              catch: function(n) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
            ...
            return r._invoke = function(n, e, t) {
              ...
              return function(o, r) {
                ...
                for (t.method = o, t.arg = r;;) {
                  ...
                  "throw" === l.type && (i = m, t.method = "throw", t.arg = l.arg)
                }
              }
            }(n, t, a), r
          }
          ...
          function I(n, e) {
            ...
            if (i === t) {
              if (e.delegate = null, "throw" === e.method) {
                if (n.iterator.return && (e.method = "return", e.arg = t, I(n, e), "throw" === e.method)) return f;
            ...
            var r = o.arg;
            return r ? r.done ? (e[n.resultName] = r.value, e.next = n.nextLoc, "return" !== e.method && (e.method = "next", e.arg = t), e.delegate = null, f) : r : (e.method = "throw", e.arg = new TypeError("iterator result is not an object"), e.delegate = null, f)
          }
  ...
  t.n = n => {
    ...
    var n = t(72),
      ...
      m = t(915),
      f = {};
    f.styleTagTransform = u(), f.setAttributes = l(), f.insert = a().bind(null, "head"), f.domAPI = o(), f.insertStyleElement = c();
    e()(m.A, f);
    ...
    async function T() {
      ...
      if (e.getAttribute("fullImageLoaded")) clearTimeout(window.slideShowMoveTransitionID), clearTimeout(window.slideShowTimeoutID), window.slideShowTimeoutID = window.setTimeout(C, n);
      else {
        const i = Date.now(),
          o = await N(`${$}screenshots/${t+1}.jpg${L}`);
        e.querySelector("img").src = o.src, e.setAttribute("fullImageLoaded", !0), clearTimeout(window.slideShowMoveTransitionID), clearTimeout(window.slideShowTimeoutID);
        const r = Date.now() - i;
      ...
      n > p.numScreenshots - 1 && (n = 0),
        function(n) {
          ...
          y.querySelectorAll(".image").forEach((n => {
            n.className === `${b} left` && (n.className = `${b} fromLeft`), n.className === `${b} right` && (n.className = `${b} fromRight`), -1 === n.className.indexOf("inactive") && (n.className += " inactive")
          }));
          ...
          i.className = `${b} right`, v.querySelectorAll(".bullet").forEach(((n, e) => {
    ...
    function F() {
      ...
      e > p.fullImageMaxHeight && (e = p.fullImageMaxHeight, t = e * x / n);
    ...
    function N(n) {
      return new Promise(((e, t) => {
        const i = new Image;
        i.addEventListener("load", (() => e(i))), i.addEventListener("error", (n => {
    ...
    function z() {
      const n = window.innerWidth,
        ...
        t = n / e;
      M.style.width = `${n}px`, M.style.height = `${e}px`, t > p.maxRatio ? M.style.width = e * p.maxRatio + "px" : t < p.minRatio && (M.style.height = n / p.minRatio + "px");
      const i = M.getBoundingClientRect();
      M.style.marginLeft = -.5 * i.width + "px", M.style.marginTop = -.5 * i.height + "px"
    }

    function _(n) {
      const e = 100 * n;
      D.style.width = `${e}%`, O.innerHTML = (e | 0) + "%", p.fileSize && (O.innerHTML += ` of ${p.fileSize}MB`);
      const t = {
        percentageDone: n
      };
      PokiSDK.gameLoadingProgress(t), n >= 1 && "done" !== R.className && (R.className = "done", document.getElementById("progress-comment").innerHTML = "Preparing game...", document.getElementById("progress-spinner").style.display = "flex", P && clearTimeout(P))
    }
    window.navigateNext = C, window.removeSlideshowEventListeners = () => {
      E = !0
    };
    let G = 0;
    ...
    function H() {
      ...
      n ? (j.innerHTML = n[G], G++, G >= n.length && (G = 0), P = setTimeout(H, p.commentChangeTime)) : j.innerHTML = ""
    }

    function q() {
      const n = document.createElement("script"),
        e = "Build";
      n.src = `${e}/${p.metadata.loader_filename}`, p.dataUrl = `${e}/${p.metadata.data_filename}`, p.frameworkUrl = `${e}/${p.metadata.framework_filename}`, p.codeUrl = `${e}/${p.metadata.code_filename}`, p.streamingAssetsUrl = "StreamingAssets", n.addEventListener("load", (() => {
        const n = document.querySelector("#game");
        createUnityInstance(n, p, _).then((n => {
          window.unityGame = n, M.style.display = "block", A.style.display = "none", z(), PokiSDK.gameLoadingFinished(), window.removeSlideshowEventListeners(), P && clearTimeout(P)
        })).catch((n => {
          console.error(n)
        }))
      })), document.body.appendChild(n), PokiSDK.gameLoadingStart(), p.fileSize && (O.innerHTML += ` of ${p.fileSize}MB`, O.style.width = "12vh", O.style.whiteSpace = "nowrap"), H()
    }
    ...
    function U() {
      ...
      M = document.getElementById("game-container"), A = document.getElementById("loader"), R = document.getElementById("progress-container"), D = document.getElementById("progress-fill"), O = document.getElementById("progress-amount"), j = document.getElementById("progress-comment"), window.addEventListener("resize", z), window.addEventListener("focus", z), window.PokiSDK.init().then((() => {
      ...
      try {
        (async function() {
          let n;
          g = document.getElementById("slideshow"), w = document.getElementById("slideshow-top"), v = document.getElementById("slideshow-nav"), y = document.getElementById("slideshow-images"), w.className = "active";
          try {
          ...
          const e = B();
          e.className = `${b} middle`, e.setAttribute("fullImageLoaded", !0), e.setAttribute("data-idx", 0), e.appendChild(n), y.appendChild(e), g.className = "active", x = n.width / n.height, S = document.createElement("style"), F(), document.body.appendChild(S), window.addEventListener("resize", F);
          for (let n = 0; n <= p.numScreenshots - 1; n++) {
            const e = document.createElement("div");
            e.className = "bullet" + (0 === n ? " active" : ""), e.setAttribute("data-idx", n), v.appendChild(e)
          }
          ...
          const i = n => {
            const e = B(),
              t = new Image;
            t.src = `${$}screenshots/${n+1}-small.jpg${L}`, e.appendChild(t), e.setAttribute("data-idx", n), 1 === n ? e.className = `${b} right` : n === p.numScreenshots - 1 ? e.className = `${b} left` : e.className = `${b} inactive`, y.appendChild(e)
          };
    ...
    J.startsWith(Q) && (J = `${Q}cdn-cgi/image/quality=78,width=40,height=40,fit=cover,g=0.5x0.5,f=auto/${J.substr(25)}`), V.src = J;
    const Z = K("slideshow-top-container"),
      nn = K("game-title");
    nn.innerText = p.title;
    const en = K("progress-spinner");
    en.innerHTML = '<div class="bounce0"></div><div class="bounce1"></div><div class="bounce2">', en.setAttribute("class", "spinner");
    ...
    hn.setAttribute("id", "game"), W.appendChild(X), X.appendChild(Y), X.appendChild(ln), X.appendChild(dn), Y.appendChild(V), Y.appendChild(Z), Z.appendChild(nn), Z.appendChild(en), Z.appendChild(tn), tn.appendChild(on), tn.appendChild(an), Z.appendChild(sn), on.appendChild(rn), cn.appendChild(hn), document.body.appendChild(W), document.body.appendChild(cn)
  })()
})();