...
media = "screen" >
  ...
  .container {
    margin: 50 px auto 40 px auto;width: 600 px;text - align: center;
  }
...
p {
  color: rgba(0, 0, 0, 0.5);margin: 20 px 0;line - height: 1.6;
}
...
li {
  display: table - cell;font - weight: bold;width: 1 % ;
}

.logo {
  display: inline - block;margin - top: 35 px;
}
.logo - img - 2 x {
  display: none;
}
